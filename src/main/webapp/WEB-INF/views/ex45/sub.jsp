...
document.querySelector("#btn7").addEventListner("click", function() {
...
document.querySelector("#btn4").addEventListner("click", function() {
	fetch(ctx+"/ex45/sub04")
});

document.querySelector("#btn3").addEventListner("click", function() {
